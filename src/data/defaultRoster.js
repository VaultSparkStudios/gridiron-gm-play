...
export function loadRoster() {
  try {
    ...
    if (raw) {
      ...
      if (data.team && data.opponent) return { team: data.team, opponent: data.opponent, week: data.week, season: data.season, gameId: data.gameId || null, stadiumUpgrades: data.stadiumUpgrades || [] };
